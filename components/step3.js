...
export default function Step3({
  ...
  // ✅ Only validate here — all Firebase logic is handled by NewOrder.js via onSubmit()
  const handleSubmit = () => {
    if (n(discount) < 0) {
  ...
  return (
    <ScrollView style={styles.stepContent}>
      ...
      <View style={styles.summaryCard}>
        ...
        <View style={styles.summaryRow}>
          <Text style={styles.summaryText}>Transport</Text>
          <Text style={styles.summaryText}>₹{transportCost.toFixed(2)}</Text>
        </View>
        ...
        {n(discount) > 0 && (
          <View style={styles.summaryRow}>
            <Text style={styles.discountSavings}>You save</Text>
            <Text style={styles.discountSavings}>- ₹{discountValue.toFixed(2)}</Text>
          </View>
        )}
